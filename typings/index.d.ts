import { Client, MessageComponent, Snowflake, Guild, Channel, User, GuildMember, Collector, CollectorFilter, Collection, CollectorOptions, APIMessageContentResolvable, MessageEmbed, MessageAttachment, StringResolvable, SplitOptions, MessageEmbedOptions, BitFieldResolvable, MessageFlagsString, MessageMentionOptions } from 'discord.js';
...
export class InteractionReply {
  constructor(client: Client, component: MessageComponent, webhook: WebhookClient);
  client: Client;
